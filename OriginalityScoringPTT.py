...
given_object = """add given object here as a string. If it consists of several words, separate them by spaces"""

#each item represents subject code and ideas of 1 person separated by '+'
data_list = [""" add title ideas here in the following format: 'subject1+idea1+idea2+...','subject2+idea1+...'
             If they consist of several words, separate them by spaces"""]
